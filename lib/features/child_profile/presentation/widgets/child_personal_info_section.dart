...
class ChildPersonalInfoSection extends StatelessWidget {
  ...
  const ChildPersonalInfoSection({
    super.key,
    required this.child,
  });
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _InfoRow(label: 'Date de naissance', value: child.birthDate ?? 'Non renseignée'),
            _InfoRow(label: 'Matières', value: child.subjects ?? 'Non renseignées'),
          ],
        ),
      ),
    );
